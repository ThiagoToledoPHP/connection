...
class ConnectionTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->obj = new Toledo\Helpers\Connection("","","","");
	}
    ...
    //start method
        ...
        //ExceptionInactive tests
            ...
            public function testConnectionStartErrorExceptionInactive(){
                $this->obj = new Toledo\Helpers\Connection(INVALID_HOST_BD,INVALID_USER_BD,INVALID_PASS_BD,INVALID_NAME_BD);
                $this->assertEquals($this->obj->start(),false);
            }


            public function testConnectionStartValidExceptionInactive(){
                $this->obj = new Toledo\Helpers\Connection(VALID_HOST_BD,VALID_USER_BD,VALID_PASS_BD,VALID_NAME_BD);
        ...
        //ExceptionActive tests
            ...
            public function testConnectionStartErrorExceptionActive(){
                $this->obj = new Toledo\Helpers\Connection(INVALID_HOST_BD,INVALID_USER_BD,INVALID_PASS_BD,INVALID_NAME_BD,true);
                $this->obj->start();
            }


            public function testConnectionStartValidExceptionActive(){
                $this->obj = new Toledo\Helpers\Connection(VALID_HOST_BD,VALID_USER_BD,VALID_PASS_BD,VALID_NAME_BD,true);
                $this->assertEquals($this->obj->start(),true);
            }
